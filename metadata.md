...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/M3ssman/gt-test/releases/tag/v2.1.2">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 20_v2.1.2</a>
      </li>
      <li>
