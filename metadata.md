...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/M3ssman/gt-test/releases/tag/v3.0.0">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 21_v3.0.0</a>
      </li>
      <li>
